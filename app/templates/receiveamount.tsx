import { View, Text, StyleSheet, Image, TextInput, Modal, FlatList, TouchableOpacity, TouchableWithoutFeedback, SafeAreaView } from 'react-native';
            ...
            <View style={styles.container}>
                ...
                <View style={styles.viewContainer}>
                    <View style={{ marginVertical: 16 }}>
                        <Text style={styles.headerTitle}>Enter request</Text>
                    ...
                    <Image
                        ...
                        style={styles.avatar}
                    />
                    <Text style={styles.userName}>Alexy sances</Text>
                    <Text style={styles.userEmail}>Alexysances123@gmail.com</Text>

            ...
            [
                ...
                },
                {
                    ...
                    onPress: async () => {
                        ...
                        try {
                            // Registrar los pagos en el servidor
                            const resultado = await registroPagos.registrarPagosLote(pagosAEntregar)

                            if (resultado.success) {
                                // Todos los pagos se registraron exitosamente
                                // Eliminar los pagos registrados del almacenamiento local
                                ...
                                // Eliminar los pagos exitosos del almacenamiento local
                                for (const pagoExitoso of resultado.resultados.exitosos) {
                                    await pagosPendientes.eliminar(pagoExitoso.pagoId)
                                }
                                ...
                                showInfo("Entrega Parcial", mensaje, [
                                    ...
                                    },
                                    {
                                        ...
                                        style: "default",
                                        onPress: () => {
                                            // Recargar la lista para mostrar solo los pagos que fallaron
                                            cargarPagos()
                                        }
                                    }
                                ])
                    ...
                    <View className="flex-row justify-end mt-2">
                        ...
                        >
                            <View className="flex-row items-center">
                                ...
                                <Text className="text-white text-xs ml-1">Ver</Text>
                            </View>
                        </Pressable>
                        <Pressable

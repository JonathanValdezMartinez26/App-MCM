...
const prevYearlyData = [
    7500, 8500, 8000, 9000, 9500, 10000, 9900, 11000, 11500, 12000, 12500, 13000
]
...
export default function SpendingScreen() {
    ...
    const summaryText = `You spent ${Math.abs(diffPercent)}% ${isPositive ? "more" : "less"} than ${
        period === "Weekly" ? "last week" : period === "Monthly" ? "last month" : "last year"
    }`
                    ...
                    {currentData.map((value, index) => {
                        ...
                        return (
                            <View key={index} style={styles.barItem}>
                                <View
                                    style={[styles.bar, { height }, isActive && styles.barActive]}
                                />

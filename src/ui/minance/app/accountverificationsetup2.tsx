...
const AccountVerificationSetup2 = () => {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.stepList}>
                    ...
                    <StepItem icon="star-outline" label="Checking up document ID" checked />
                    <StepItem icon="camera-outline" label="Verification Photo" checked={false} />
                </View>
                <Button
                    title="Next"
                    filled
                    onPress={() => navigation.navigate('accountverificationselfie')}
                    style={{
...
export default AccountVerificationSetup2
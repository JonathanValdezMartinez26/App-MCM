import { View, TextInput, TouchableOpacity, Image, Text, StyleSheet, Modal, TouchableWithoutFeedback, SafeAreaView } from 'react-native';
...
type ChatScreenNavigationProp = NavigationProp<any>;
...
interface CustomMessage extends IMessage {
  image?: string; // Optional property for image URLs
}
...
const Chat: React.FC<ChatProps> = () => {
  ...
  const [outputMessage, setOutputMessage] = useState<string>('Results to be shown here.');
  ...
  const SYSTEM_PROMPT = "You are the support assistant for Minance, a banking application. Your role is to help users with their banking questions.";

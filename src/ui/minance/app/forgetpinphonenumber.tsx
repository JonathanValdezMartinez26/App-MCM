...
import { View, Text, ScrollView, Pressable, StyleSheet, TouchableOpacity, TextInput, SafeAreaView } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('forgetpinentercode', { phone: `+${callingCode}${phone}` })}
...
export default ForgetPasswordPhoneNumberScreen

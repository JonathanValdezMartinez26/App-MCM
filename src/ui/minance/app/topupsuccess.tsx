...
import { View, Text, StyleSheet, TouchableOpacity, Share, Image, ScrollView, Pressable } from 'react-native';
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.bottomSection}>
                    ...
                    <View style={styles.card}>
                        <Text style={styles.requestText}>Total Request</Text>
                        <Text style={styles.requestAmount}>$120,00</Text>
                        ...
                        <View style={styles.row}>
                            <Text style={styles.label}>Topup Destination</Text>
